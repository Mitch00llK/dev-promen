    ...
    <div id="a11y-widget-panel" 
        ...
        <div class="a11y-widget__header">
            <div class="a11y-widget__header-main">
                <h2 id="a11y-widget-title" class="a11y-widget__title">
                    <?php esc_html_e('Accessibility', 'promen-elementor-widgets'); ?>
                </h2>
                <div class="a11y-widget__header-actions">
                    <button type="button" class="a11y-widget__reset" id="a11y-reset-all" aria-label="<?php esc_attr_e('Reset settings', 'promen-elementor-widgets'); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                        </svg>
                    </button>
                    <button type="button" class="a11y-widget__close" aria-label="<?php esc_attr_e('Close menu', 'promen-elementor-widgets'); ?>">
        ...
        <div class="a11y-widget__content">
            ...
            <section class="a11y-widget__section a11y-widget__section--profiles">
                <h3 class="a11y-widget__section-title"><?php esc_html_e('Profiles', 'promen-elementor-widgets'); ?></h3>
                <div class="a11y-widget__profiles">
                    <button type="button" class="a11y-widget__profile" data-profile="vision-impaired">
                        ...
                        <span class="a11y-widget__profile-label"><?php esc_html_e('Vision', 'promen-elementor-widgets'); ?></span>
                    </button>
                    ...
                    <button type="button" class="a11y-widget__profile" data-profile="seizure-safe">
                        ...
                        <span class="a11y-widget__profile-label"><?php esc_html_e('Seizure', 'promen-elementor-widgets'); ?></span>
                    </button>
            ...
            <section class="a11y-widget__section">
                <h3 class="a11y-widget__section-title"><?php esc_html_e('Display', 'promen-elementor-widgets'); ?></h3>
                ...
                <div class="a11y-widget__contrast-grid">
                     <button type="button" class="a11y-widget__contrast-btn" data-setting="high-contrast" aria-label="<?php esc_attr_e('High Contrast', 'promen-elementor-widgets'); ?>">
                        <span class="a11y-swatch a11y-swatch--high"></span>
                        <span class="a11y-label"><?php esc_html_e('High', 'promen-elementor-widgets'); ?></span>
                    </button>
                    <button type="button" class="a11y-widget__contrast-btn" data-setting="dark-contrast" aria-label="<?php esc_attr_e('Dark Contrast', 'promen-elementor-widgets'); ?>">
                        <span class="a11y-swatch a11y-swatch--dark"></span>
                        <span class="a11y-label"><?php esc_html_e('Dark', 'promen-elementor-widgets'); ?></span>
                    </button>
                    <button type="button" class="a11y-widget__contrast-btn" data-setting="light-contrast" aria-label="<?php esc_attr_e('Light Contrast', 'promen-elementor-widgets'); ?>">
                        <span class="a11y-swatch a11y-swatch--light"></span>
                        <span class="a11y-label"><?php esc_html_e('Light', 'promen-elementor-widgets'); ?></span>
                    </button>
                    <button type="button" class="a11y-widget__contrast-btn" data-setting="invert-colors" aria-label="<?php esc_attr_e('Invert Colors', 'promen-elementor-widgets'); ?>">
                        <span class="a11y-swatch a11y-swatch--invert"></span>
                        <span class="a11y-label"><?php esc_html_e('Invert', 'promen-elementor-widgets'); ?></span>
                    </button>
                </div>
            </section>
            ...
            <!-- Content Adjustments -->
            <section class="a11y-widget__section">
                <h3 class="a11y-widget__section-title"><?php esc_html_e('Content', 'promen-elementor-widgets'); ?></h3>
                ...
                <div class="a11y-widget__switch-list">
                    ...
                    <div class="a11y-widget__switch-row">
                        <div class="a11y-widget__switch-info">
                            ...
                            <span class="a11y-label"><?php esc_html_e('Readable Font', 'promen-elementor-widgets'); ?></span>
                        </div>
                    ...
                    <div class="a11y-widget__switch-row">
                        <div class="a11y-widget__switch-info">
                            ...
                            <span class="a11y-label"><?php esc_html_e('Highlight Links', 'promen-elementor-widgets'); ?></span>
                        </div>
                    ...
                    <div class="a11y-widget__switch-row">
                        <div class="a11y-widget__switch-info">
                            ...
                            <span class="a11y-label"><?php esc_html_e('Highlight Headers', 'promen-elementor-widgets'); ?></span>
                        </div>
            ...
            <!-- Interaction -->
            <section class="a11y-widget__section">
                <h3 class="a11y-widget__section-title"><?php esc_html_e('Interaction', 'promen-elementor-widgets'); ?></h3>
                ...
                <div class="a11y-widget__switch-list">
                    ...
                    <div class="a11y-widget__switch-row">
                        <div class="a11y-widget__switch-info">
                            ...
                            <span class="a11y-label"><?php esc_html_e('Big Cursor', 'promen-elementor-widgets'); ?></span>
                        </div>
                    ...
                    <div class="a11y-widget__switch-row">
                        <div class="a11y-widget__switch-info">
                            ...
                            <span class="a11y-label"><?php esc_html_e('Reading Guide', 'promen-elementor-widgets'); ?></span>
                        </div>
                    ...
                    <div class="a11y-widget__switch-row">
                        <div class="a11y-widget__switch-info">
                            ...
                            <span class="a11y-label"><?php esc_html_e('Reading Mask', 'promen-elementor-widgets'); ?></span>
                        </div>
                    ...
                    <div class="a11y-widget__switch-row">
                        <div class="a11y-widget__switch-info">
                            ...
                            <span class="a11y-label"><?php esc_html_e('Read Page', 'promen-elementor-widgets'); ?></span>
                        </div>
            ...
            <details class="a11y-widget__details">
                <summary class="a11y-widget__details-summary">
                    <?php esc_html_e('More Options', 'promen-elementor-widgets'); ?>
                ...
                <div class="a11y-widget__switch-list">
                    ...
                    <div class="a11y-widget__switch-row">
                        <div class="a11y-widget__switch-info">
                            ...
                            <span class="a11y-label"><?php esc_html_e('Stop Animations', 'promen-elementor-widgets'); ?></span>
                        </div>
                    ...
                    <div class="a11y-widget__switch-row">
                        <div class="a11y-widget__switch-info">
                            ...
                            <span class="a11y-label"><?php esc_html_e('Hide Images', 'promen-elementor-widgets'); ?></span>
                        </div>
