 ...
 * This function will be called from the main widget class.
 * 
 * @param Contact_Info_Card_Widget $widget The widget instance
 */
function register_style_controls_for_contact_info_card($widget) {
    ...
    // Add calls to additional style control functions here as needed
} 