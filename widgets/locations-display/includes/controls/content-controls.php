<?php
/**
 * Locations Display Content Controls
 *
 * @package Promen
 */
...
class Promen_Locations_Display_Content_Controls {
    ...
    public static function register_controls($widget) {
        ...
        self::register_locations_section($widget);
        self::register_animation_section($widget);
    }
    ...
    /**
     * Register locations section controls
     */
    private static function register_locations_section($widget) {
        $widget->start_controls_section(
            'section_locations',
            [
    ...
    /**
     * Register animation section controls
     */
    private static function register_animation_section($widget) {
        $widget->start_controls_section(
            'section_animation',
            [
