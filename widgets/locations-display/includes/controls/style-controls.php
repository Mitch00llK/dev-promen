<?php
/**
 * Locations Display Style Controls
 *
 * @package Promen
 */
...
class Promen_Locations_Display_Style_Controls {
    ...
    public static function register_controls($widget) {
        ...
        self::register_grid_style_section($widget);
        self::register_item_style_section($widget);
        self::register_image_style_section($widget);
        self::register_name_style_section($widget);
        self::register_address_style_section($widget);
    }

    /**
     * Register heading style section
     */
    ...
    /**
     * Register grid style section
     */
    private static function register_grid_style_section($widget) {
        $widget->start_controls_section(
            'section_grid_style',
            [
    ...
    /**
     * Register item style section
     */
    private static function register_item_style_section($widget) {
        $widget->start_controls_section(
        ...
        $widget->add_responsive_control(
            ...
            [
                ...
                'range' => [
                    ...
                    'vh' => ['min' => 10, 'max' => 50, 'step' => 1],
                    'rem' => ['min' => 5, 'max' => 30, 'step' => 1],
                ],
                'default' => [
                    'unit' => 'px',
                    'size' => 250,
    ...
    /**
     * Register name style section
     */
    private static function register_name_style_section($widget) {
        $widget->start_controls_section(
            'section_name_style',
            [
    ...
    /**
     * Register address style section
     */
    private static function register_address_style_section($widget) {
        $widget->start_controls_section(
