...
$this->add_control(
    ...
    [
        ...
        'default' => '#E6EDF8',
        'selectors' => [
            '{{WRAPPER}} .content-filter-button:not(.active):hover' => 'background-color: {{VALUE}};',
        ],
    ]
);
...
$this->add_control(
    ...
    [
        ...
        'default' => '#002D72',
        'selectors' => [
            '{{WRAPPER}} .content-filter-button:not(.active):hover' => 'color: {{VALUE}};',
        ],
    ]
);
...
$this->add_control(
    ...
    [
        ...
        'default' => '#002D72',
        'selectors' => [
            '{{WRAPPER}} .content-filter-button:not(.active):hover' => 'border-color: {{VALUE}};',
        ],
    ]
);
...
$this->add_control(
    ...
    [
        ...
        'selectors' => [
            '{{WRAPPER}} .content-filter-button' => 'transition: all {{SIZE}}{{UNIT}};',
        ],
    ]
);
