<?php
/**
 * Default Slider Template for News Posts Widget
 * 
...
$slider_id = 'promen-news-slider-' . uniqid();
...
<div class="promen-news-slider-container" role="region" aria-label="<?php echo esc_attr__('Content slider', 'promen-elementor-widgets'); ?>">
    <!-- Slider main container -->
    <div id="<?php echo esc_attr($slider_id); ?>" 
         class="swiper promen-news-slider" 
         role="region" 
        ...
        <div class="swiper-wrapper">
            ...
            ?>
                ...
                <div class="swiper-slide" 
                    ...
                    <article class="promen-content-card <?php echo esc_attr($settings['post_type']); ?>-card">
                        ...
                        <div class="promen-content-content">
                            <span id="slider-post-title-<?php echo esc_attr(get_the_ID()); ?>" class="promen-content-post-title"><?php the_title(); ?></span>
                            
                            <?php if ($settings['post_type'] === 'vacatures') : ?>
