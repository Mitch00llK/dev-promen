    ...
    const HamburgerMenuAccessibility = {
                ...
                if ($submenu.length && !$item.find('.submenu-toggle').length) {
                    ...
                    const $toggle = $(`
                        <button type="button" 
                            ...
                            <span class="screen-reader-text">Klik om het ${$link.text()} submenu uit te klappen</span>
                        </button>
                    `);
        ...
        toggleMenu: function(e) {
            ...
            if (!isOpen) {
                ...
                HamburgerMenuAccessibility.announceToUser('Het navigatiemenu is geopend en u kunt nu door de menu-items navigeren');
                ...
                HamburgerMenuAccessibility.announceToUser('Het navigatiemenu is gesloten');
            }
        },
        ...
        toggleSubmenu: function(e) {
            ...
            if (isOpen) {
                ...
                $toggle.find('.screen-reader-text').text(`Klik om het ${linkText} submenu uit te klappen`);
            } else {
                ...
                $toggle.find('.screen-reader-text').text(`Klik om het ${linkText} submenu in te klappen`);
            }

            // Announce change
            const announcement = isOpen ? `Het ${linkText} submenu is ingevouwen` : `Het ${linkText} submenu is uitgevouwen`;
        ...
        setMenuState: function($menu, isOpen) {
            ...
            if (isOpen) {
                ...
                $toggle.attr('aria-label', 'Klik om het navigatiemenu te sluiten');
                $toggle.find('.screen-reader-text').text('Klik om het menu te sluiten');
                $panel.attr('tabindex', '-1');
            } else {
                $menu.removeClass('menu-open');
                $toggle.attr('aria-label', 'Klik om het navigatiemenu te openen');
                $toggle.find('.screen-reader-text').text('Klik om het menu te openen');
        ...
        getToggleLabel: function(itemText, isExpanded) {
            const action = isExpanded ? 'Klik om in te klappen' : 'Klik om uit te klappen';
            return `${action} het ${itemText} submenu`;
        },
