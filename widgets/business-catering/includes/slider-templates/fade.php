...
<div class="promen-catering-slider-container promen-catering-fade-slider-container">
    <!-- Slider main container -->
    <div id="<?php echo esc_attr($slider_id); ?>" class="swiper promen-catering-slider promen-catering-fade-slider"<?php echo $slider_attr_string; ?>>
