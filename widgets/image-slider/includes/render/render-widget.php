                            ...
                            <div class="promen-slider-image-wrapper">
                                <div class="promen-slider-image elementor-animation-<?php echo esc_attr($settings['image_hover_animation']); ?>">
                                    <?php if (!empty($item['image']['url'])) : ?>
                                        ...
                                        if ($settings['image_height'] === 'aspect_ratio') {
                                        ...
                                        if ($settings['image_height'] !== 'default' && !empty($settings['image_object_fit'])) {
                                            $image_classes .= ' object-fit-' . esc_attr($settings['image_object_fit']);
                                        }
                                        ...
                                        <?php if ($settings['image_height'] === 'aspect_ratio') : ?>
                                            </div>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    ...
                                    <?php if (($settings['show_image_title'] === 'yes' || $settings['show_image_description'] === 'yes') && 
                                        ...
                                        <div class="promen-slider-overlay<?php echo $settings['show_overlay_on_hover'] === 'yes' ? ' hover-overlay' : ''; ?>">
                                            <?php if ($settings['show_image_title'] === 'yes' && !empty($image_title)) : ?>
                                                <p class="promen-slider-overlay-title"><?php echo esc_html($image_title); ?></p>
                                            <?php endif; ?>
                                            
                                            <?php if ($settings['show_image_description'] === 'yes' && !empty($image_description)) : ?>
