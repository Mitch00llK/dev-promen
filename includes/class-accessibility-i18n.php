...
class Promen_Accessibility_i18n {
    ...
    public static function get_strings() {
        return [
            ...
            'skipToMainContent' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipToNavigation' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipImageTextBlock' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipToSection' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipTextBlock' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipLocations' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipTextColumns' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipRelatedServices' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipTeamCarousel' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipStats' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipTestimonial' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipWorkerTestimonial' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipTimeline' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipCarousel' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipSlider' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
            'skipGallery' => __('Sla over naar inhoud', 'promen-elementor-widgets'),
